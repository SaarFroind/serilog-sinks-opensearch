...
namespace Serilog.Sinks.OpenSearch
{
    ...
    public class OpenSearchTemplateProvider
    {
        ...
        private static object GetTemplateESv8(OpenSearchSinkOptions options, int discoveredMajorVersion,
            Dictionary<string, string> settings,
            string templateMatchString)
        {
        ...
        private static object GetTemplateESv7(OpenSearchSinkOptions options, int discoveredMajorVersion,
            Dictionary<string, string> settings,
            string templateMatchString)
        {
            object mappings = new
        ...
        private static object GetTemplateESv6(OpenSearchSinkOptions options, int discoveredMajorVersion,
            Dictionary<string, string> settings,
            string templateMatchString)
        {
            object mappings = new
            ...
            mappings = discoveredMajorVersion == 7 ? new { _doc = mappings } : new { _default_ = mappings };
